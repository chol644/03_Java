...
public class MethodRefTest {
    public static void main(String[] args) {
        ...
        System.out.println("abs1.apply(-1) : " + abs1.apply(-10));

        // 2) 람다식으로 변경
        Function<Integer, Integer> abs2 = integer -> Math.abs(integer);
        System.out.println("abs2.apply(-1) : " + abs2.apply(-10));
        ...
        System.out.println("lower3 = " + lower2.get());
        ...
        */
        ...
        // nameList.forEach(System.out::println);
        // == nameList의 모든 요소를 순차 접근 하면서 각 요소를 System.out(PrintStream)의
